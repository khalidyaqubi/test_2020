...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /*اعدادات الموقع*/
        $permission36_id = DB::table('permissions')->insertGetId(['name' => 'setting', 'guard_name' => 'web', 'title' => 'اعدادات الموقع', 'icon' => 'group', 'link' => '', 'order_id' => 7, 'in_menu' => 1,  'parent_id' => 0]);
        $permission37_id = DB::table('permissions')->insertGetId(['name' => 'edit setting', 'guard_name' => 'web', 'title' => 'تعديل اعدادت الموقع', 'icon' => 'equalizer', 'link' => '/admin/setting/edit', 'order_id' => 1, 'in_menu' => 0,  'parent_id' => $permission36_id]);
