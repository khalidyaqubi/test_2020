...
@section('pageTitle','إدارة فئات المشاريع')
@section('headerCSS')
@endsection
                                ...
                                <td>
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/p_categories/{{$item->id}}/edit"><i
                                                        class="fa fa-pen"></i>
                                                تعديل
                                            </a>
                                            <a class="dropdown-item Confirm" href="/admin/p_categories/delete/{{$item->id}}">
