                    ...
                    <div class="kt-login__signin">
                        ...
                        <form class="kt-form" method="post" action="{{ route('password.email') }}">
                            ...
                            <div class="input-group">
                                <input class="form-control" style="background-color: #ddd8e5;" type="email" name="email" value="{{ old('email') }}"
 ...
 <div class="row kt-login__extra">
                            ...
                            <div class="kt-login__actions">
                                <button id="kt_login_signin_submit"
                                        class="btn btn-brand btn-elevate kt-login__btn-primary">استعادة كلمة السر
                                </button>
                            </div>
