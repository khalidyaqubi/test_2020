...
@section('content')
                    ...
                    <div class="single_reson">
                        ...
                        <div class="help_content">
                            ...
                            <h6> @if(config('app.locale')=='en')
                                ...
                                @endif</h6>
                            <a href="/articles/{{$article->id}}" class="read_more">{{trans('my-word.Read More')}}</a>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single_counter d-flex align-items-center justify-content-center">
                            ...
                            <div class="events">
                                <h3 class="counter d-inline">98 </h3><h3 class=" d-inline"><span>%</span></h3>
                ...
                <div class="col-lg-7">
                    <div class="activites_info">
                        ...
                        <p class="para_1">@if(config('app.locale')=='en')
                            ...
                            @endif</p>
                        <a href="projects/{{$fixed_project->id}}/donations" data-scroll-nav="1" class="boxed-btn4">{{trans('my-word.Make a Donate')}}</a>
                    </div>
                </div>
            </div>
                @endif
    ...
    <!--Our Media Start-->
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url({{ asset($setting->media_img) }});" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
